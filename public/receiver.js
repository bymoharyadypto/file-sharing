(function(){
    ...
    function generateID(){
        return `${Math.trunc(Math.random()*1000).toString().padStart(3, '0')}-${Math.trunc(Math.random()*1000).toString().padStart(3, '0')}-${Math.trunc(Math.random()*1000).toString().padStart(3, '0')}`;
        // const randomNumber = () => {
        //     const number = Math.trunc(Math.random() * 999);
